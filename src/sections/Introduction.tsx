    ...
    <div className="relative py-20">
      ...
      <div className="flex gap-4 section z-10">
        <div className="flex-1 flex flex-col gap-12 text-white text-center my-auto z-2">
          ...
          <div className="flex gap-3 mx-auto text-5xl items-center hero-tech-list h-20">
        ...
        <div className="flex-1 max-w-170 bg-background/70 text-white border border-white shadow-lg p-6 rounded-xl z-1">
